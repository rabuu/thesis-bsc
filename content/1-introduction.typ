...
In recent times, however, the sequent calculus @Gentzen1935a[ sec. III], another logical proof system by Gentzen, or specifically its corresponding term assignment system, the $lambda mu tilde(mu)$-calculus @Curien2000, has been found to offer a compelling alternative as basis for compiler design @Binder2024grokking @Downen2016sequent @Schuster2025 @Mueller2026.
...
The central idea is to provide the low-level stages of the compilation pipeline with additional information about the linearity of continuations and use this information for more efficient memory management in the resulting machine code.

The remainder of this thesis is organized as follows:

In @ch:scc, we summarize the SCC pipeline that is the foundation of the thesis.
We introduce all compiler stages and the translations between them.
...
In @ch:conclusion, we conclude by summarizing the results of this thesis and giving directions on future work.
